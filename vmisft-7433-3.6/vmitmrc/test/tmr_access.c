...
int main()
{
        ...
        fd_set fds;
        int initial_count = 0xffff;     /* This is a 32-bit counter */
        ...
        write(fd2, &initial_count, sizeof (initial_count));
        ...
        write(fd1, &initial_count, sizeof (initial_count));
        ...
        printf("Read access time is %.2fus\n",
               (initial_count - count) / num_passes);
